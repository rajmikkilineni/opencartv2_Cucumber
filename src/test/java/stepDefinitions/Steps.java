...
public class Steps {
    ...
    public void user_enters_email_as_and_password_as(String email, String pwd) {
        ...
        lp.setEmail(email);
        lp.setPassword(pwd);
        logger.info("Provided email and Passwpord");
    }
    ...
    public void user_navigates_to_register_account_page() {
        ...
        if (regpage.isRegisterAccountPageDisplayed()) {
            Assert.assertTrue(true);
        } else {
            Assert.assertTrue(false);
        }
    ...
    public void user_provide_valid_details() {
        ...
        logger.info("");
        regpage.setLastName("Mike");
        regpage.setEmail(RandomStringUtils.randomAlphabetic(5) + "@yahoo.com");//Random email
        regpage.setTelephone("3224345342");
        regpage.setPassword("wewewr");
        regpage.setConfirmPassword("wewewr");
